    ...
    <div class="row">
      ...
      <div class="col-2 d-flex flex-column"> 
        <div class="p-2 hide-md">
          <img src="../img/ps-indi-product1.jpg" class="float-left" onclick="pictureChangeFirstPS()"/>
        </div>
        <div class="p-2 hide-md">
          <img src="../img/nc-indi-product2.jpg" class="float-left" onclick="pictureChangeSecondPS()"/>
        </div>
        <div class="p-2 hide-md">
          <img src="../img/nc-indi-product3.jpg" class="float-left" onclick="pictureChangeThirdPS()"/>
        </div>
      </div>
      ...
      <div class="row show-md mx-auto">
        <div class="col-12 d-flex">
            <div class="p-2">
              <img src="../img/ps-indi-product1.jpg" class="indi-pictureChanger" onclick="pictureChangeFirstPS()"/>
            </div>
            <div class="p-2">
              <img src="../img/nc-indi-product2.jpg" class="indi-pictureChanger" onclick="pictureChangeSecondPS()"/>
            </div>
            <div class="p-2">
              <img src="../img/nc-indi-product3.jpg" class="indi-pictureChanger" onclick="pictureChangeThirdPS()"/>
            </div>
        </div>
      </div>
      ...
      <div class="col-md-5">
        ...
        <div class="move-center">
          <!--Shopify buy button-->
          <div id='product-component-d7ba040650b'></div>
        </div>
      </div>
    </div>
    ...
    function ShopifyBuyInit() {
      ...
      ShopifyBuy.UI.onReady(client).then(function (ui) {
        ui.createComponent('product', {
          id: [11887200714],
          node: document.getElementById('product-component-d7ba040650b'),
