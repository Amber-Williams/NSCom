    ...
    <div class="row">
      ...
      <div class="col-2 d-flex flex-column"> 
        <div class="p-2 hide-md">
          <img src="../img/indi-stuff/white-rx/116x116-Psoriasis-30mL-Tube-Carton-Shadow.jpg" class="float-left" onclick="pictureChangeFirstPS()"/>
        </div>
        <div class="p-2 hide-md">
          <img src="../img/indi-stuff/116x116-Psoriasis-Smear.jpg" class="float-left" onclick="pictureChangeSecondPS()"/>
        </div>
        <div class="p-2 hide-md">
          <img src="../img/indi-stuff/white-rx/116x116-Psoriasis-Drug-Facts-V1.jpg" class="float-left" onclick="pictureChangeThirdPS()"/>
        </div>
      </div>

      <div class="col-md-5">
        <div class="d-flex align-items-center indi-display">
          <img id="indi-display-img" src="../img/indi-stuff/white-rx/1800x2160-Psoriasis-30mL-Tube-Carton-Shadow.png" class="float-right"/>
        </div>
      </div>
      ...
      <div class="row show-md mx-auto">
        <div class="col-12 d-flex">
            <div class="p-2">
              <img src="../img/indi-stuff/white-rx/116x116-Psoriasis-30mL-Tube-Carton-Shadow.jpg" class="indi-pictureChanger" onclick="pictureChangeFirstPS()"/>
            </div>
            <div class="p-2">
              <img src="../img/indi-stuff/116x116-Psoriasis-Smear.jpg" class="indi-pictureChanger" onclick="pictureChangeSecondPS()"/>
            </div>
            <div class="p-2">
              <img src="../img/indi-stuff/white-rx/116x116-Psoriasis-Drug-Facts-V1.jpg" class="indi-pictureChanger" onclick="pictureChangeThirdPS()"/>
            </div>
        </div>
      </div>
