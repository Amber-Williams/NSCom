  ...
  <div class="container ">
    ...
    <div class="row">
      <div class="col-12 move-center my-3">
        <a href="#products"><img src="../img/down.png"/></a>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-12 move-center my-3">
      <a href="#farms"><img src="../img/down.png"/></a>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-12 move-center my-3">
      <a href="#philosophy"><img src="../img/down.png"/></a>
      </div>
    </div>

    <div id="philosophy" class="row">
      <div class="col-12">
        <h1> Philosophy</h1>
        <p>Based on our firm belief in our three tenets – Core Science, Real Results, Continuous Advancement in farming and formulating, and GMP quality manufacturing, Nerium SkinCare is committed to being the industry leader with innovative high quality, safe products.</p>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-12 move-center my-3">
        <a href="#leadership"><img src="../img/down.png"/></a>
      </div>
    </div>
