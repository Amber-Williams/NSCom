    ...
    <div class="row">
      ...
      <div class="col-2 d-flex flex-column"> 
        <div class="p-2 hide-md">
          <img src="../img/ps-indi-product1.jpg" class="float-left" onclick="pictureChangeFirstDermal()"/>
        </div>
        <div class="p-2 hide-md">
          <img src="../img/nc-indi-product2.jpg" class="float-left" onclick="pictureChangeSecondDermal()"/>
        </div>
        <div class="p-2 hide-md">
          <img src="../img/nc-indi-product3.jpg" class="float-left" onclick="pictureChangeThirdDermal()"/>
        </div>
      </div>
      ...
      <div class="row show-md mx-auto">
        <div class="col-12 d-flex">
            <div class="p-2">
              <img src="../img/ps-indi-product1.jpg" class="indi-pictureChanger" onclick="pictureChangeFirstDermal()"/>
            </div>
            <div class="p-2">
              <img src="../img/nc-indi-product2.jpg" class="indi-pictureChanger" onclick="pictureChangeSecondDermal()"/>
            </div>
            <div class="p-2">
              <img src="../img/nc-indi-product3.jpg" class="indi-pictureChanger" onclick="pictureChangeThirdDermal()"/>
            </div>
        </div>
      </div>
      ...
      <div class="col-md-5">
        ...
        <div class="move-center">
          <!--Shopify buy button-->
          <div id='product-component-87fdc6c11c8'></div>
        </div>
      </div>
    </div>
      ...
      <div class="row mb-5">
        <div class="col-md-7">
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-sm-6 col-md-4 text-center">
              <img src="../img/indi-stuff/dermal-pain-symptoms/NSC.TL.Website.Symptoms_DP.2.Sunburn.png" alt="Sun Burn" width="50%"/>
              <p>Sun Burn</p>
            </div>
            <div class="col-sm-6 col-md-4 text-center">
          ...
          <div class="col-md-7">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10 d-flex align-items-center">
                <p class="p-indi mb-0">Apply to shingles, sun-burn, scrapes, insect bites and other dermal pain related conditions 3 to 4 times daily for fast-acting pain relief.</p>
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-sm-2">
    ...
    function ShopifyBuyInit() {
      ...
      ShopifyBuy.UI.onReady(client).then(function (ui) {
        ui.createComponent('product', {
          id: [320240680970],
          node: document.getElementById('product-component-87fdc6c11c8'),
