    ...
    <div class="row">
      ...
      <div class="col-2 d-flex flex-column"> 
        <div class="p-2 hide-md">
          <img src="../img/body-indi-product1.jpg" class="float-left" onclick="pictureChangeFirst()"/>
        </div>
        <div class="p-2 hide-md">
      ...
      <div class="row show-md mx-auto">
        <div class="col-12 d-flex">
            <div class="p-2">
              <img src="../img/body-indi-product1.jpg" class="indi-pictureChanger" onclick="pictureChangeFirst()"/>
            </div>
            <div class="p-2">
